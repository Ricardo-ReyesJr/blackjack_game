...
'''
# The value of the A's is 11 or 1.
# a = 1 or 11
...
if play_game == 'n' or play_game == 'N':
    ...
    print()
    print('The goal of the game is to reach a total of 21 using a set of poker cards')
    time.sleep(2)
    print('The value of each card is as follows: A = 1 or 11 | 10, J, Q, K = 10 | 2 - 9 are face value')
    time.sleep(2)
